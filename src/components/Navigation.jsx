...
const navigation = [
    ...
    { name: 'About', href: '/about', icon: PiUsersBold },
    { name: 'Contact Us', href: '/contact', icon: MdOutlineLocalPhone },
];
                        ...
                        <div className="hidden lg:flex lg:gap-x-12">
                            {navigation.map((item) => (
                                <a key={item.name} href={item.href} className="text-sm font-semibold leading-6 text-white">
                                    <div className='flex items-center'><item.icon className='mx-2' size={20} /> {item.name}</div>
                                </a>
                            ))}
                        </div>
